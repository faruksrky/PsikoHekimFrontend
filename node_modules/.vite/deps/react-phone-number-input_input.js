...
function usePhoneDigits(_ref) {
  ...
  var getInitialPhoneDigits = function getInitialPhoneDigits2(options) {
    ...
    return getPhoneDigitsForValue(value, country, international, withCountryCallingCode, defaultCountry, useNationalFormatForDefaultCountryValue, metadata2, function() {
  ...
  }, [country, international, withCountryCallingCode, defaultCountry, metadata2, setPhoneDigits, setValueForPhoneDigits, rerender, countryMismatchDetected]);
  return [phoneDigits, onSetPhoneDigits];
}
function getPhoneDigitsForValue(value, country, international, withCountryCallingCode, defaultCountry, useNationalFormatForDefaultCountryValue, metadata2, onCountryMismatch) {
  if (country && international && withCountryCallingCode) {
    var prefix = getInternationalPhoneNumberPrefix(country, metadata2);
    if (value) {
