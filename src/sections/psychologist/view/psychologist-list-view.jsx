...
import { PsychologistTableRow } from '../psychologist-table-row';
import { PsychologistTableToolbar } from '../psychologist-table-toolbar';
import { PsychologistTableFiltersResult } from '../psychologist-table-filters-result';
...
export function PsychologistListView() {
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Psikolog', href: paths.dashboard.user.root },
            { name: 'Psikolog Listesi' },
          ]}
          action={
            <Button
...
<Card sx={{ width: '100%', overflowX: 'auto' }}>
            ...
            <PsychologistTableToolbar
              filters={filters}
              onResetPage={table.onResetPage}
            />

            {canReset && (
              <PsychologistTableFiltersResult
                filters={filters}
